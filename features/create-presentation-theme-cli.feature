Feature: Create new presentation theme
  ...
  Given a presentation theme named "new_theme" does not exist
  When I successfully run `middleman create_theme new_theme --no-javascripts-directory`
  ...
  Given a presentation theme named "new_theme" does not exist
  When I successfully run `middleman create_theme new_theme --no-stylesheets-directory`
  Then a presentation theme named "new_theme" should exist
  And a directory named "new_theme/stylesheets" should not exist

  Scenario: No images
  Given a presentation theme named "new_theme" does not exist
  When I successfully run `middleman create_theme new_theme --no-images-directory`
  Then a presentation theme named "new_theme" should exist
