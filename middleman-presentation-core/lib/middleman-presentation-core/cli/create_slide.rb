  ...
  module Presentation
    module Cli
      ...
      class CreateSlide < BaseGroup
        ...
        class_option :edit, default: Middleman::Presentation.config.edit, desc: Middleman::Presentation.t('views.slides.create.options.edit')
        class_option :editor_command, default: Middleman::Presentation.config.editor_command, desc: Middleman::Presentation.t('views.slides.create.options.editor_command')
