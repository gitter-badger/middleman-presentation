  ...
  module Presentation
    module Cli
      ...
      class CreatePresentation < BaseGroup
        ...
        class_option :width, type: :numeric, default: Middleman::Presentation.config.width, desc: Middleman::Presentation.t('views.presentations.create.options.width')
        class_option :height, type: :numeric, default: Middleman::Presentation.config.height, desc: Middleman::Presentation.t('views.presentations.create.options.height')
        class_option :margin, type: :numeric, default: Middleman::Presentation.config.margin, desc: Middleman::Presentation.t('views.presentations.create.options.margin')
        class_option :min_scale, type: :numeric, default: Middleman::Presentation.config.min_scale, desc: Middleman::Presentation.t('views.presentations.create.options.min_scale')
        class_option :max_scale, type: :numeric, default: Middleman::Presentation.config.max_scale, desc: Middleman::Presentation.t('views.presentations.create.options.max_scale')
        ...
        class_option :runtime_environment, default: Middleman::Presentation.config.runtime_environment.to_s, desc: Middleman::Presentation.t('views.presentations.create.options.runtime_environment')
