...
module Middleman
  ...
  module Presentation
    ...
    @frontend_components_manager = FrontendComponentsManager.new(bower_directory: File.join(Middleman::Application.server.inst.root, @config.bower_directory))
    ...
    class << self
      attr_reader :config, :logger, :plugins_manager, :frontend_components_manager, :helpers_manager, :assets_manager, :locale_configurator, :assets_loader, :asset_components_manager
